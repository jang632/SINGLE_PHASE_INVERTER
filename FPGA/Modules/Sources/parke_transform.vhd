...
architecture Behavioral of parke_transform is
  ...
  signal v_d_full : signed(63 downto 0);
  signal v_q_full : signed(63 downto 0);
  ...
  begin
    if rising_edge(clk) then
      if rst = '1' then
        ...
        v_d_full <= v_alpha_delayed * cos_val + v_beta_delayed * sin_val;
        v_q_full <= v_beta_delayed  * cos_val - v_alpha_delayed * sin_val;
      end if;
    end if;
  end process;

  v_d <= shift_left(v_d_full(63 downto 32), 1);
  v_q <= shift_left(v_q_full(63 downto 32), 1);
